            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合 <span v-show="isOne" class="iconfont " :class="{'icon-down_light':isAsc,'icon-arrowup':isDesc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格 <span v-show="isTwo" class="iconfont " :class="{'icon-down_light':isAsc,'icon-arrowup':isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      ...mapState({
        total:state=>state.search.searchList.data.data.total
      })
    },
    methods: {
      ...
      getData(){
        // this.$store.dispatch('getSearchList',this.searchParams,this.params)
      ...
      // 排序操作
      changeOrder(flag){
        // flag：它是一个标记，代表的是用户点击的是综合(1)价格(2)[用户点击的时候传递进来]
